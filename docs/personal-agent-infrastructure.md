...
16. **PR 15+ — remaining Phase 1 connectors** (Google Drive, Notion, Jira, Linear, Replicate, X-Twitter), one per PR. Each must pass `assertContractClean` cleanly.
