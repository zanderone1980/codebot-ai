...
13. **PR 12+ — remaining Phase 1 connectors**, one per PR. Each must pass `assertContractClean` cleanly. Per the §10 ladder, Google Calendar is next.
