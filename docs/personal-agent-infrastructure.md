...
18. **PR 20+ — remaining Phase 1 connectors** (Jira, Linear, X-Twitter, then Replicate last because paid generation needs the spend-money pass), one per PR. Each must pass `assertContractClean` cleanly.
